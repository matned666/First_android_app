...
public class CollisionActivity extends AppCompatActivity  implements DatePickerDialog.OnDateSetListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.collision_layout);
        initView();
    }

    private void initView() {
        confirmButton = findViewById(R.id.collision_confirm);
        dateEditText = findViewById(R.id.collision_date);
        costEditText = findViewById(R.id.collision_cost);
        descriptionEditText = findViewById(R.id.collision_description);
        dateLabel = findViewById(R.id.collision_date_label);
        costLabel = findViewById(R.id.collision_cost_label);
        descriptionLabel = findViewById(R.id.collision_description_label);
    ...
    private void addOnClickListener_ToConfirmButton() {
        confirmButton.setOnClickListener(v -> {
            ...
            if (textValidate(descriptionEditText, descriptionLabel, getResources().getString(R.string.description))
                ...
                Record repair = new Record.Builder(RecordType.COLLISION, getDate())
                        .costInPLN(getCost())
    ...
    private void datePickDialog() {
        ...
        DatePickerDialog datePicker = new DatePickerDialog(CollisionActivity.this, (DatePickerDialog.OnDateSetListener) CollisionActivity.this, year,month,day);
        datePicker.show();
    }
