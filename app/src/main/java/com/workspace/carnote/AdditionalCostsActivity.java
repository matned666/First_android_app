...
public class AdditionalCostsActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.additional_cost_layout);
        initView();
    }

    private void initView() {
        confirmButton = findViewById(R.id.cost_confirm);
    ...
    private void addOnClickListener_ToConfirmButton() {
        confirmButton.setOnClickListener(v -> {
            ...
            if (textValidate(descriptionEditText, descriptionLabel, getResources().getString(R.string.description))
                ...
                Record repair = new Record.Builder(RecordType.COST, getDate())
                        .costInPLN(getCost())
